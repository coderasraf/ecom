 		...
 		<tbody>
 			<?php 
 				...
 				<tr>
	 				...
	 				<td class="text-center" width="200px"><?php echo $row['cat_desc']; ?></td>
	 				<td class="text-center">
	 					<a href="index.php?edit_cat=<?php echo($row['cat_id']); ?>" class="btn btn-primary btn-round"><i class="fa fa-pen"></i></a>
	 					<a onclick="return confirm('Are u sure to delete this Product Categroy!');" href="index.php?delete_cat=<?php echo($row['cat_id']); ?>" class="btn btn-danger btn-round"><i class="fa fa-trash"></i></a>
	 				</td>
 			 </tr>
