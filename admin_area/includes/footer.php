...
<div class="copyright-area p-3" style="background: #333;color: #fff"><!--copyright section start-->
	<div class="container">
		<div class="row">
...
<script src="../assets/plugins/jquery-datatable/dataTables.bootstrap4.min.css"></script>
<script src="../assets/plugins/jquery-datatable/buttons.print.min.js"></script>
<script src="../assets/plugins/jquery-datatable/buttons.html5.min.js"></script>
<script src="../assets/plugins/jquery-datatable/buttons.flash.min.js"></script>
<script src="../assets/plugins/jquery-datatable/buttons.colVis.min.js"></script>
<script src="../assets/plugins/jquery-datatable/dataTables.bootstrap4.min.js"></script>
<script src="../assets/plugins/jquery-datatable/dataTables.buttons.min.js"></script>
