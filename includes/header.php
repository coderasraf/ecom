 	...
 	<div class="container"><!-- header container start -->
 	  ...
 	  <div class="row">
 		<div class="col-md-7 col-sm-12 offer"><!-- col-md-6 offer  start-->
 			...
 			<a href="" class="text-light carts">Shopping Cart Total Price: BDT 300, Total Item: <span style="font-size: 17px; font-weight: bold;">2</span></a>
 		</div><!-- col-md-6 offer  end-->

 		<div class="col-md-5 col-sm-12 "><!-- Top Menu Start-->
 			<ul class="menu">
 				<li><a href="customer_registaration.php">Register</a></li>
